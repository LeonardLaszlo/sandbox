...
public interface Consultant {
     ...
     *
     * @param gameBoard an in-progress game.
     * @return The CellLocation that this consultant chooses to suggest. Must be
     * a cell having EMPTY state
     * @throws NullPointerException  if {@code gameBoard} is {@code null}
     * @throws IllegalStateException if {@code gameBoard} represents a game that is over, i.e.
