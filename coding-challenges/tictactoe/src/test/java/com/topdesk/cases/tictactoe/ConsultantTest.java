...
public class ConsultantTest {
    ...
    public void avoidsBadEarlyMove() {
        assertNotEquals(consultant.suggest(board("only_one_not_winning_move01")), CellLocation.CENTRE_LEFT);
    }
    ...
    private static void assertInList(CellLocation actual, CellLocation... validSuggestion) {
        if (Arrays.stream(validSuggestion).noneMatch(item -> item.equals(actual))) {
